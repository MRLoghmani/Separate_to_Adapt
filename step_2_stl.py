...
def get_dataset():
    ...
    train_dataset = STL10('../data', split='train', download=True,
    ...
    test_dataset = CIFAR10('../data', train=True, download=True,
            transform=transforms.Compose([
                transforms.Resize(32),
                transforms.RandomHorizontalFlip(p=0.5),
                transforms.RandomCrop(28),
...
discriminator_t.load_state_dict(torch.load('discriminator_a_stl.pkl'))
...
feature_extractor.load_state_dict(torch.load('feature_extractor_a_stl.pkl'))
